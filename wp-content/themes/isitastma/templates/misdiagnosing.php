<?php /* Template Name: Misdiagnosing */ ?>
<?php
get_header();
?>
	<div class="container misdiag-container">
		<div class="col-md-6 col-sm-6 col-xs-12 asthma-like-conditions">
			...
			<ul>
				...
				<li>Lung cancer (tumors)</li>
				<li>Viral infections</li>
				<li>Sinus infections</li>
				<li>Chronic Obstructive Pulmonary Disease (emphysema or chronic bronchitis)</li>
				<li>Bronchiolitis</li>
				<li>Pulmonary embolism</li>
				<li>Recurrent cough not due to asthma</li>
				<li>Transient wheeze not due to asthma</li>
				<li>Acid reflux (gastrointestinal reflux)</li>
				<li>Obesity</li>
				<li>Heart attack</li>
				<li>Hiatal hernia</li>
			</ul>
		...
		<div class="col-md-6 col-sm-6 col-xs-12 misdiagnosing-asthma">
